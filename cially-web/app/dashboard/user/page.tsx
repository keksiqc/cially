...
function ClientComponent() {
	...
	let [userData, setUserData] = useState({loading: false})
	...
	return (
		<>
            ...
            { (userData.loading === true) ? <div>loading</div> : <div className="place-self-center w-full mt-10 ">
				<Card className="mx-5">
					<CardHeader>
					...
					<CardContent>
						<div className="grid grid-cols-2 gap-3">
							<div className="place-self-start">
								<div>
									Joins: <div className="inline text-gray-300">1</div>
								</div>
								<div>
									Leaves: <div className="inline text-gray-300">3</div>
								</div>
								<div>
									Total Messages:{" "}
									<div className="inline text-gray-300">129</div>
								</div>
							</div>
							<div className="place-self-start">
								<div>
								...
								<div>
									Most Active Channel:{" "}
									<div className="inline text-gray-300">#tsavalen-romalem</div>
								</div>
							</div>
						</div>
					</CardContent>
